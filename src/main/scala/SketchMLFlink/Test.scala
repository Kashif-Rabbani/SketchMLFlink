...
object Test {
  def main(args: Array[String]): Unit = {
    ...
    val dataSet: DataSet[LabeledVector] = MLUtils.readLibSVM(env, "D:\\kddb.t\\kddb.t").first(100)
    ...
    evaluationPairs.writeAsText("file:\\D:\\Bdapro\\parallelisimOne.txt", WriteMode.OVERWRITE).setParallelism(1)
