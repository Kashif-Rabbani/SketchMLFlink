...
object MLConfSketch{
  ...
  def apply(): MLConfSketch = new MLConfSketch(null,null,null,null,null,null,null,null,null,null,null,null,
...
case class MLConfSketch (algo: String, input: String, format: String, workerNum: Int,
